...
<section class="capabilities">
  <div class="capability">
    <h2>Automation</h2>
    <p>Robotics, PLC/HMI integration, and manufacturing systems designed for reliability.</p>
  </div>
  <div class="capability">
    <h2>Systems</h2>
    <p>Mechanical design, sensing, controls, and validation built as one complete system.</p>
  </div>
  <div class="capability">
    <h2>Execution</h2>
    <p>Engineering decisions shaped by practical constraints, iteration, and what fails first.</p>
  </div>
</section>
